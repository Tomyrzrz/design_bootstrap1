...
<head>
  ...
  <title>Projects In Design</title>
 ...
 <div class="container">
    <div class="bg-dark p-2 m-3 rounded">
      ...
      <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
        <div class="col-md-5 p-lg-5 mx-auto my-5">
          <h1 class="display-4 fw-normal">Design Projects</h1>
      ...
      <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
        <div class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
          <div class="my-3 py-3">
            <h2 class="display-5">Another Design Cool</h2>
            <p class="lead">Is a one design that you may have in your house.</p>
          </div>
          <div class="bg-light shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;">
            <img src="./images/carousel1.jpg" alt="Ecological 1" width="90%" height="90%" class="img-responsive">
          </div>
        </div>
        <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
          <div class="my-3 p-3">
            <h2 class="display-5">One Design More</h2>
    ...
    <div class="container col-xxl-8 px-4 py-5">
      <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
        ...
        <div class="col-lg-6">
          <h1 class="display-5 fw-bold lh-1 mb-3 text-white-50">Very Cheap Design</h1>
          <p class="lead text-white">Quickly Design and customize your design of your home.
  ...
  <div class="bg-dark text-secondary px-4 py-5 text-center">
    <div class="py-5">
      <h1 class="display-5 fw-bold text-white">A Family Ecological</h1>
      <div class="col-lg-6 mx-auto">
        <p class="fs-5 mb-4">Quickly design and customize responsive mobile-first
  ...
  <div class="px-4 pt-5 my-5 text-center border-bottom">
      <h1 class="display-4 fw-bold text-white-50">Ecological Centered Design</h1>
      <div class="col-lg-6 mx-auto">
        <p class="lead mb-4 text-white">Quickly design and customize responsive 
